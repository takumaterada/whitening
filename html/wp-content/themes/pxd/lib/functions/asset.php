...
if( !is_admin() ){
  ...
  function bzb_register_style(){
    ...
    wp_register_style( 'page-css', get_template_directory_uri().'/page.css' );
    wp_register_style( 'animate-css', get_template_directory_uri().'/lib/css/animate.css' );
...
if (!is_admin()) {
  ...
  function bzb_register_script(){
    ...
    wp_register_script('function', get_stylesheet_directory_uri().'/js/function.js', array('jquery'), false, true );
  }
